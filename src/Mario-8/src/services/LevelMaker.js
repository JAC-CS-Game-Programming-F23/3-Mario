...
export default class LevelMaker {
	...
	static generateChasm(tiles, x, height, tileSet, topperSet, chasmCounter) {
		...
		else if (getRandomPositiveInteger(0, LevelMaker.CHASM_CHANCE) === 1) {
	...
	static generateColumn(tiles, x, height, tileSet, topperSet) {
		const isPillar = getRandomPositiveInteger(0, LevelMaker.PILLAR_CHANCE) === 1;
